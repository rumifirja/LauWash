        ...
        <div class="report">
            <div class="report-wrapper">
                <div class="report-card">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                if (isset($_POST['cari'])) {
                                    ...
                                    $qry_user = mysqli_query($conn, "SELECT u.id, u.nama, u.username, u.role FROM user u WHERE role='owner'");
                                }
                                $action = "owner";
                                $no = 0;
                    ...
                    <div class="register">
                        <a href="tambah_user.php?action=<?= $action ?>"><button>Tambah Owner</button></a>
                    </div>
                </div>
            </div>
        </div>
