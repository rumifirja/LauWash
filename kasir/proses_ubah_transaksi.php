...
$sql = "update transaksi join detail_transaksi on detail_transaksi.id_transaksi = transaksi.id_transaksi set dibayar = '" . $dibayar . "', tgl_bayar = '" . $tgl_bayar . "', status = '" . $status . "' where id_detail_transaksi = '" . $dt_detail_transaksi['id_detail_transaksi'] . "' ";
